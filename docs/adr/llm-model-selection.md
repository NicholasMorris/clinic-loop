...
- **google/gemma-4-e4b**: 29/30 passing (family: gemma)
...
- The judge model (google/gemma-4-e4b) from a different family provides independent grading with 29/30 passing.
...
- Judge model achieves 29/30 passing from a different family.
