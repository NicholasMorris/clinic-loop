...
def test_entities_are_frozen_and_synthetic_only() -> None:
    ...
    for entity_cls in entity_classes:
        with pytest.raises(ValidationError):
            # Get the required fields from an existing valid instance
            if entity_cls == Patient:
                Patient(
                    patient_id="P000001",
                    market="AU",
                    full_name="Test",
